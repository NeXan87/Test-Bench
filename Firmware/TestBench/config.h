...
// ACS712-20A: 100 mV/A
// ACS712-30A: 66 mV/A
#define M_VPER_AMPERE 66.0f  // Чувствительность датчика ACS712. mV на 1 ампер тока. Используется для пересчёта показаний ADC в амперы.
...
#define CURRENT_ALPHA 0.3f   // Коэффициент сглаживания EMA фильтра (экспоненциальное скользящее среднее). 0.0 — полностью сглажено (нет реакции), 1.0 — мгновенная реакция (без фильтра)
#define VOLTAGE_ACS712 4.96   // Напряжение питания датчика для расчёта напряжения на выходе
